...
function entrySnapshot(e) {
  ...
  return {
    ...
    age,
    gender: c.gender,
    city: c.profile.residence?.city || c.profile.city || null,
    country: c.profile.residence?.country || c.profile.country || null,
    state: c.profile.residence?.state || null,
    nationality: c.profile.nationality || c.profile.countryOfOrigin || null,
    ...
    height: c.profile.heightCm ?? c.profile.height ?? null,
    // Appearance (physical descriptors — never skin tone, §0).
    weightKg: c.profile.weightKg ?? null,
    build: c.profile.build || null,
    beard: c.profile.beard || null,
    hijab: c.profile.hijab || null,
    dressingStyle: c.profile.dressingStyle || null,
    ...
    // Beliefs & practice + family (profile free-text; shown to matches).
    aqidah: c.profile.aqidah || null,
    islamicPractice: c.profile.islamicPractice || null,
    scholars: c.profile.scholars || null,
    aboutFamily: c.profile.aboutFamily || null,
    livingArrangement: c.profile.livingArrangement || null,
    lookingForSpouse: c.profile.lookingForSpouse || null,
    lookingForFamily: c.profile.lookingForFamily || null,
...
function chatProfile(userSnap, appSnap) {
  ...
  return {
    ...
    height: p.heightCm ?? p.height ?? null,
    weightKg: p.weightKg ?? null,
    build: p.build || null,
    beard: p.beard || null,
    hijab: p.hijab || null,
    dressingStyle: p.dressingStyle || null,
    madhhab: p.madhhab || null,
    revert: p.revert === true,
    prayer: a.prayer || null,
    timeframe: a.timeframe || null,
    quranEngagement: p.deenDetail?.quranEngagement || null,
    ...
    aqidah: p.aqidah || null,
    islamicPractice: p.islamicPractice || null,
    scholars: p.scholars || null,
    aboutFamily: p.aboutFamily || null,
