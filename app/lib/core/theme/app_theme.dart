...
class DarkTokens {
  ...
  // Secondary text. Floored at .7 so muted/hint copy on the sage ground clears
  // WCAG AA — the faint .4/.5 call-sites were below it, which matters here
  // because Walis skew older.
  static Color muted([double o = .62]) => ivory.withOpacity(o < .7 ? .7 : o);
...
class LightTokens {
  ...
  static Color muted([double o = .62]) => ink.withOpacity(o < .7 ? .7 : o);
